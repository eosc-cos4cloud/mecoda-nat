...
from .models import Project, Observation, Taxon, Photo, IconicTaxon
...
def test_get_project_from_name_returns_observations_data(requests_mock,) -> None:
    expected_result = Project(
        ...
        title="URBAMAR",
        icon_url="natusfera.gbif.es/attachments/projects/icons/1191/span2/Ilustracio%CC%81n-sin-ti%CC%81tulo.png?1595350663",
